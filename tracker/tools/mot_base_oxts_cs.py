...
from lib.common_utils import oxts_kitti, cs_utils
...
eval_dir = pathlib.Path('/home/sgs/rtmot/FoxtsA') / DETECTOR / ('Car_'+args.split+'_h'+str(args.high_score)+'_c2'+'_tc1.02') / 'data'
